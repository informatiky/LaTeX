...
This extended essay will investigate scale free networks which are representative of many real-world networks because of their "Hubs". A scale free network gives a power a relation between the degree of a node and the probability of its occurence. In other words, $$ P_{(deg)}\propto k^{-\gamma} $$ where $\gamma$ is some exponent.
