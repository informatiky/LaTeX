...
For clarity, I will define the following terms, as they are different around the world:\par
A node is the same as a vertex and is the undivisble point at which one or more edges meet.\par
An edge is the connection between nodes.\par
The degree of a node is the number of connections, i.e. edges, it has to another node.  \par
...
To generate scale free networks, different algorithms exist. Among them is the 
