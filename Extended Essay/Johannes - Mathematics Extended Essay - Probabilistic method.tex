...
\begin{description}
    \item[Node] A \underline{node} is the same as a vertex and is the undivisble point at which one or more edges meet.\par
    \item[Edge] An \underline{edge} is the connection between nodes.\par
