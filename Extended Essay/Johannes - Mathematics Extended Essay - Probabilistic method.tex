...
To generate scale free networks, different methods exist. At their core, they aim to define the type of relation between. The one this extended essay will focus on is the Chung-Lu Configuration Model. 
