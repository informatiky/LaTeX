...
To understand the rest of this essay, it is important to clarify the concept of combinations. Imagine a simple cake in which all ingredients are mixed independent of the order. In mathematical language, that is called a combination of objects. On the other hand, a phone password or arrangement of  Furthermore, the following notation will occur commonly. 
