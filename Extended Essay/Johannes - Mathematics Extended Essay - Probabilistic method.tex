...
\begin{itemize}
    \item A node is the same as a vertex and is the undivisble point at which one or more edges meet.\par
    \item An edge is the connection between nodes.\par
    \item The degree of a node is the number of connections, i.e. edges, it has to another node.  \par
\end{itemize}
...
To generate scale free networks, different methods exist. At their core, they aim to define the type of relation between. The one this extended essay will focus on is the Chung-Lu Configuration Model it allows better analysis because of its dynamic charactersitics meaning it is . 
