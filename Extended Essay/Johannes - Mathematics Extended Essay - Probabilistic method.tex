...
To understand the rest of the essay, it is important to clarify the concept of combinations. Imagine a simple cake in which all ingredients are mixed independent of the order. In mathematical langFurthermore, the following notation will occur commonly. 
