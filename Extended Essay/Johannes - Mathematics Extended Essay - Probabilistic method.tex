...
\begin{itemize}
    \itemA node is the same as a vertex and is the undivisble point at which one or more edges meet.\par
    \itemAn edge is the connection between nodes.\par
\itemThe degree of a node is the number of connections, i.e. edges, it has to another node.  \par
\end{itemize}
