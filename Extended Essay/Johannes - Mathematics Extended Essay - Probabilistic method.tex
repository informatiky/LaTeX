...
To generate scale free networks, different methods exist. The greater category of the most commonly used model is called \textit{configuration model} because it allows  At their core, they aim to define the type of relation between. The one this extended essay will focus on is the Chung-Lu Configuration Model it allows better analysis because of its dynamic charactersitics meaning it is . 
